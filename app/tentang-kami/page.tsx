...
export default function TentangKamiPage() {
  ...
  const shareText = "Pustaka IIMaN - Penerbit Profesional & Berpengalaman di Indonesia";
        ...
        <div className="bg-white border border-gray-200 rounded-3xl p-6 sm:p-10 md:p-12 shadow-xs relative overflow-hidden">
          <div className="relative z-10 max-w-3xl space-y-4">
            ...
            <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-[#272522] leading-tight tracking-tight">
              Penerbitan Bermakna, <span className="text-[#C12A26] italic font-serif">Menginspirasi Peradaban</span>
            </h1>
            <p className="text-sm sm:text-base text-[#76716A] leading-relaxed font-sans">
              Didirikan sejak tahun 2001, Pustaka IIMaN hadir sebagai rumah penerbitan profesional yang mendedikasikan diri untuk mencerdaskan kehidupan bangsa melalui literasi berkualitas tinggi, baik karya penulis tanah air maupun karya terjemahan dari Bahasa Arab dan Inggris.
            </p>
          </div>

          {/* Key Milestones Counter Grid */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 pt-8 border-t border-gray-100">
            <div className="p-4 bg-gray-50/80 border border-gray-200/60 rounded-2xl">
              <div className="text-2xl sm:text-3xl font-black font-serif text-[#E52E2D]">2001</div>
              <p className="text-xs text-gray-500 font-medium mt-1">Tahun Berdiri Resmi</p>
            </div>
            <div className="p-4 bg-gray-50/80 border border-gray-200/60 rounded-2xl">
              <div className="text-2xl sm:text-3xl font-black font-serif text-[#272522]">500+</div>
              <p className="text-xs text-gray-500 font-medium mt-1">Judul Buku Diterbitkan</p>
            </div>
            <div className="p-4 bg-gray-50/80 border border-gray-200/60 rounded-2xl">
              <div className="text-2xl sm:text-3xl font-black font-serif text-[#E52E2D]">100%</div>
              <p className="text-xs text-gray-500 font-medium mt-1">Kualitas Keilmuan Kurasi</p>
            </div>
            <div className="p-4 bg-gray-50/80 border border-gray-200/60 rounded-2xl">
              <div className="text-2xl sm:text-3xl font-black font-serif text-[#272522]">Top Best-Seller</div>
              <p className="text-xs text-gray-500 font-medium mt-1">Kategori Buku Favorit</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-3xl p-6 sm:p-10 shadow-xs space-y-6">
          <div className="border-b border-gray-100 pb-4">
            ...
            <h2 className="font-serif text-2xl sm:text-3xl font-bold text-gray-900 mt-1">
              Pilar Keunggulan Pustaka IIMaN
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="space-y-2 p-4 bg-gray-50/60 rounded-2xl border border-gray-100">
              ...
              <h3 className="font-bold text-sm text-gray-900">Kurasi Naskah Ketat</h3>
            ...
            <div className="space-y-2 p-4 bg-gray-50/60 rounded-2xl border border-gray-100">
              ...
              <h3 className="font-bold text-sm text-gray-900">Jembatan Bahasa & Budaya</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <div className="space-y-2 p-4 bg-gray-50/60 rounded-2xl border border-gray-100">
              ...
              <h3 className="font-bold text-sm text-gray-900">Best-Seller Berkualitas</h3>
              <p className="text-xs text-gray-500 leading-relaxed">
        ...
        <div className="bg-gradient-to-r from-gray-900 via-[#272522] to-gray-900 rounded-3xl p-6 sm:p-10 text-white shadow-md flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2 text-center md:text-left">
            ...
            <h3 className="font-serif text-2xl sm:text-3xl font-bold tracking-tight">
              Ingin Menerbitkan Naskah Bersama Pustaka IIMaN?
            </h3>
